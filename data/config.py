...
my_dataset = Config({'name': 'my databases',
                       'train_images': './data/images_coco/',
                       'train_info': './data/images_coco/annotations.json',
...
my_res101_backbone = Config({'name': 'my_res101',
                             'path': 'my_res101.pth',
                             'type': ResNetBackbone,
                             'args': ([3, 4, 23, 3],),
                             'transform': resnet_transform,
